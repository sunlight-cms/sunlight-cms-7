...
if (!defined('_header') || '' === _header) {
    ...
    $scriptPath = realpath($_SERVER['DOCUMENT_ROOT'] . $_SERVER['SCRIPT_NAME']);
    $rootPath = realpath(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR);
    if (
        $scriptPath === $rootPath . DIRECTORY_SEPARATOR . 'index.php'
        || $scriptPath === $rootPath . DIRECTORY_SEPARATOR . 'admin' . DIRECTORY_SEPARATOR . 'index.php'
    ) {
