...
if ($continue) {
  ...
  ";
    if (!$new) {
        $custom_settings .= "&nbsp;&nbsp;<label><input type='checkbox' name='delposts' value='1' /> " . $_lang['admin.content.form.delposts'] . "</label> <small>(" . DB::result(DB::query("SELECT COUNT(id) FROM `" . _mysql_prefix . "-posts` WHERE home=" . $id . " AND type=3"), 0) . ")</small>";
    }
