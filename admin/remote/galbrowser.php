...
foreach ($items as $item) {
    ...
    print "
<tr" . $hl_class . ">
<td colspan='2'><a href='#' onclick=\"return _sysGalBrowse('" . _htmlStr($dirhref) . "/');\"><img src='images/icons/fman/dir.png' alt='dir' class='icon' />" . _htmlStr(_cutStr($item, 64, false)) . "</a></td>
</tr>
";
